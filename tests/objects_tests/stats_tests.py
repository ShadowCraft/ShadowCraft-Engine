...
class TestStats(unittest.TestCase):
    ...
    def test_get_mastery_from_rating(self):
        self.assertAlmostEqual(self.stats.get_mastery_from_rating(), 8 + 1234 / 350)
        self.assertAlmostEqual(self.stats.get_mastery_from_rating(100),  8 + 100 / 350)

    def test_get_versatility_multiplier_from_rating(self):
        self.assertAlmostEqual(self.stats.get_versatility_multiplier_from_rating(), 1 + 1222 / 40000)
        self.assertAlmostEqual(self.stats.get_versatility_multiplier_from_rating(100), 1 + 100 / 40000)

    def test_get_crit_from_rating(self):
        self.assertAlmostEqual(self.stats.get_crit_from_rating(), 899 / 35000)
        self.assertAlmostEqual(self.stats.get_crit_from_rating(100), 100 / 35000)

    def test_get_haste_multiplier_from_rating(self):
        self.assertAlmostEqual(self.stats.get_haste_multiplier_from_rating(), 1 + 666 / 32500)
        self.assertAlmostEqual(self.stats.get_haste_multiplier_from_rating(100), 1 + 100 / 32500)
